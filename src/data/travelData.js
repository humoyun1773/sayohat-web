...
export const REVIEWS = [
  {
    id: 1,
    name: 'Sardor Rahimov',
    nameUz: 'Sardor Rahimov',
    nameRu: 'Сардор Рахимов',
    nameEn: 'Sardor Rahimov',
    avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=200&q=80',
    rating: 5,
    roleUz: 'Tadbirkor, Samarqand safari',
    roleRu: 'Предприниматель, Самарканд',
    roleEn: 'Entrepreneur, Samarkand Tour',
    countryUz: 'Samarqand Turi',
    countryRu: 'Тур в Самарканд',
    countryEn: 'Samarkand Tour',
  ...
  },
  {
    ...
    countryUz: 'Xiva Turi',
    countryRu: 'Тур в Хиву',
    countryEn: 'Khiva Tour',
  ...
  },
  {
    ...
    nameUz: 'Jasurbek Mahmudov',
    nameRu: 'Жасурбек Махмудов',
    nameEn: 'Jasurbek Mahmudov',
    ...
    countryUz: 'Termiz Turi',
    countryRu: 'Тур в Термез',
    countryEn: 'Termez Tour',
