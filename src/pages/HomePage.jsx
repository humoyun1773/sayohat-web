...
export default function HomePage() {
  ...
  return (
    <div className="space-y-16 sm:space-y-24 pb-20 overflow-hidden bg-[#fafbfc]">
      
      {/* ========================================================================= */}
      {/* 1. HERO SECTION: Clean Modern Mesh Gradient (No image background) */}
      {/* ========================================================================= */}
      <section className="relative min-h-[88vh] pt-28 sm:pt-36 pb-16 sm:pb-24 flex items-center justify-center overflow-hidden bg-gradient-to-b from-emerald-50/70 via-teal-50/30 to-transparent bg-dot-pattern">
        
        {/* Animated Ambient Glowing Orbs */}
        <div className="absolute top-10 left-1/2 -translate-x-1/2 w-[700px] h-[450px] bg-gradient-to-tr from-emerald-400/20 via-teal-300/20 to-sky-300/15 blur-3xl rounded-full pointer-events-none animate-pulse-glow"></div>
        <div className="absolute -top-20 -left-20 w-80 h-80 bg-emerald-300/15 rounded-full blur-3xl pointer-events-none animate-blob"></div>
        <div className="absolute top-1/3 -right-20 w-80 h-80 bg-teal-300/15 rounded-full blur-3xl pointer-events-none animate-blob" style={{ animationDelay: '3s' }}></div>
                ...
                <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-2 pt-2">
                    ...
                    <button
                      ...
                      className="py-2.5 px-3 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs text-center transition-colors shadow-sm cursor-pointer hover:shadow-md"
                    >
                      Bron Qilish
                    </button>
                  </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          >
            ...
            <div className="relative z-10">
              <Link
                to="/deals"
                className="inline-flex items-center gap-2 py-3 px-6 rounded-2xl bg-white text-slate-950 font-black text-xs hover:bg-amber-50 transition-all shadow-md hover:scale-105"
              >
          ...
          >
            ...
            <div className="relative z-10">
              <Link
                to="/media"
                className="inline-flex items-center gap-2 py-3 px-6 rounded-2xl bg-emerald-500 hover:bg-emerald-600 text-white font-black text-xs transition-all shadow-md hover:scale-105"
              >
        ...
        >
          ...
          <div className="max-w-3xl space-y-6 relative z-10">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              <Link
                to="/tours"
                className="py-3.5 px-6 rounded-2xl bg-emerald-500 hover:bg-emerald-600 text-white font-black text-xs tracking-wide shadow-lg shadow-emerald-500/25 transition-all flex items-center gap-2 hover:scale-105"
              >
              ...
              <a
                ...
                className="py-3.5 px-4 rounded-2xl bg-white/5 hover:bg-white/10 text-emerald-400 font-mono font-bold text-xs flex items-center gap-2 border border-white/10 hover:scale-105"
              >
